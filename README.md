...
Simple MLP project for the BINUS course **Deep Learning and Its Application**.

This repository contains a Jupyter notebook that:

- downloads the `rezkyyayang/pekerja-sejahtera` dataset from Kaggle,
- performs exploratory analysis and preprocessing,
- trains a simple multilayer perceptron (MLP) with TensorFlow.

## Project Contents

- `pekerja_sejahtera.ipynb`: main notebook for the project
- `pyproject.toml`: Python dependencies managed with Poetry
- `poetry.lock`: locked dependency versions
- `dataset/`: local cache for downloaded CSV files
